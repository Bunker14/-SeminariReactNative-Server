...
import { insertUser,getUsers,getUser,updateUser,deleteUser, loginUser} from "../services/user";
...
const login_User=async({params}:Request,res:Response)=>{
    try{
...
export{getPerson,getPeople,postPerson,updatePerson,deletePerson, login_User};